...
export default class SelectProductImageDialogComponent extends BaseDialog<SelectProductImageDialogComponent> implements OnInit{
  ...
  @Output() options: Partial<FileUploadOptions> = {
    ...
    action: "upload",
    controller: "products",
    explanation: "Product photos choose or drop here...",
    IsAdminPage: true,
